...
public class JedisIndex {
	...
	public void add(String term, TermCounter tc) {
		...
		String urlKey = termCounterKey(tc.getLabel());
		jedis.hset(urlKey, term, tc.get(term).toString());
	}
	...
	public Set<String> getURLs(String term) {
		...
		Set<String> urlsContainingTerm = jedis.smembers(urlKey);
		if (urlsContainingTerm.isEmpty()) {
			return null;
		}
		return urlsContainingTerm;
	}
